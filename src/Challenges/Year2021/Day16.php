...
class Packet
{
    ...
    public static function fromHexa($hexa, $parent = null): self
    {
        $binary = '';
    ...
    public static function fromBinary($binary, $parent = null): self
    {
        return new self($binary, $parent);
    }
    ...
    public function __construct($binary, $parent = null)
    {
        ...
        if (self::TYPE_LITTERAL === $this->getType()) {
    ...
    private function calculateLitteral()
    {
        ...
        while ($hasMoreByte) {
            $hasMoreByte = '1' == substr($this->packet, $offset, 1);
...
class Day16 extends ChallengeBase
{
    public const TYPE_LITTERAL = 4;
